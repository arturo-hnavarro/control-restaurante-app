    ...
    <div class="mx-auto">
        ...
        <script type="text/javascript">
            ...
            function obtenerOrdenTemplate() {
                ...
                template += '<button type="button"  class="btn btn-primary p-2"  onclick="facturarOrden([[ID]],[[ID_ESTADO]])" data-bs-toggle="modal" data-bs-target="#facturarModal" [[OCULTO2]]>Facturar</button>';
                template += '</div >';
                template += '</br >';
                template += '</div >';
                template += '</div >';
